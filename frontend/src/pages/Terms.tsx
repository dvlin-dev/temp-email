  ...
  return (
    ...
    <div>
      <div className="max-w-[1400px] ">
        <p className="mt-8">
          Welcome to temp-email.DEV! These Terms of Service ("Terms") govern your
        ...
        <p className="mt-4">
          temp-email.DEV is a minimalistic temporary email service that allows you to
          ...
          temp-email.DEV operates on the Cloudflare network, guaranteeing a
        ...
        <p className="mt-4">
          2.1 Availability: Please note that temp-email.DEV is not available in China
          Mainland. We apologize for any inconvenience caused.
        </p>
        <p className="mt-4">
          2.2 Copyright: All copyrights related to temp-email.DEV and its services
          belong to temp-email.DEV. You may not copy, reproduce, distribute, modify,
          or create derivative works of temp-email.DEV or any part thereof without
          explicit permission from temp-email.DEV.
        </p>
        ...
        <p className="mt-4">
          ...
          personal information to use temp-email.DEV. However, you are solely
          responsible for maintaining the confidentiality of any temporary email
          addresses generated through our service.
        </p>
        <p className="mt-4">
          3.2 Prohibited Activities: While using temp-email.DEV, you agree not to
        ...
        <p className="mt-4">
          temp-email.DEV is provided on an "as is" and "as available" basis. We do
          not warrant that our services will be uninterrupted, error-free, or
          secure. Your use of temp-email.DEV is at your own risk, and we disclaim all
        ...
        <p className="mt-4">
          To the maximum extent permitted by law, in no event shall temp-email.DEV or
          ...
          from your access to or use of temp-email.DEV or any content or services
          provided through temp-email.DEV.
        </p>
        ...
        <p className="mt-4">
          ...
          posting. Your continued use of temp-email.DEV after the posting of any
        ...
        <p className="mt-4">
          ...
          laws of the jurisdiction where temp-email.DEV is located. Any disputes
